        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecentlyOpenedPostsIds = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AllowNsfw = table.Column<bool>(type: "bit", nullable: true),
                    ColorThemeId = table.Column<int>(type: "int", nullable: true),
                    PostsRead = table.Column<int>(type: "int", nullable: true),
                    CommentsWritten = table.Column<int>(type: "int", nullable: true),
                    PostsWritten = table.Column<int>(type: "int", nullable: true),
                    MessagesWritten = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BaseMessage_BaseChat_ChatId",
                        column: x => x.ChatId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ChatId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TimeOfJoining = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatUsers_BaseChat_ChatId",
                        column: x => x.ChatId,
                        principalTable: "BaseChat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
